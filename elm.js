...
var _elm_lang$elm_architecture_tutorial$Main$markerRect = function (marker) {
	var _p0 = marker.size;
	var sX = _p0._0;
	var sY = _p0._1;
	var _p1 = marker.xy;
	var posX = _p1._0;
	var posY = _p1._1;
	var xStr = _elm_lang$core$Basics$toString(posX);
	var yStr = _elm_lang$core$Basics$toString(posY);
	return A2(
		_elm_lang$svg$Svg$rect,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$fill(marker.color),
				_elm_lang$svg$Svg_Attributes$x(xStr),
				_elm_lang$svg$Svg_Attributes$y(yStr),
...
var _elm_lang$elm_architecture_tutorial$Main$view = function (model) {
	var _p2 = model.bounds;
	var boundsX = _p2._0;
	var boundY = _p2._1;
	var boundaryX = _elm_lang$core$Basics$toString(boundsX);
	var boundaryY = _elm_lang$core$Basics$toString(boundY);
	return A2(
		_elm_lang$svg$Svg$svg,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$version('1.1'),
				_elm_lang$svg$Svg_Attributes$width(boundaryX),
				_elm_lang$svg$Svg_Attributes$height(boundaryY),
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						boundaryX,
						A2(_elm_lang$core$Basics_ops['++'], ' ', boundaryY))))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$width(boundaryX),
						_elm_lang$svg$Svg_Attributes$height(boundaryY),
						_elm_lang$svg$Svg_Attributes$fill('grey')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$elm_architecture_tutorial$Main$markerRect(model)
					]))
			]));
};
var _elm_lang$elm_architecture_tutorial$Main$applyPhysics = F2(
	function (dt, model) {
		var _p3 = model.speed;
		var speedX = _p3._0;
		var speedY = _p3._1;
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				xy: {
					ctor: '_Tuple2',
					_0: x + (((speedX * _elm_lang$core$Basics$round(dt)) / 20) | 0),
					_1: y + (((speedY * _elm_lang$core$Basics$round(dt)) / 20) | 0)
				}
			});
	});
var _elm_lang$elm_architecture_tutorial$Main$killSpeed = F2(
	function (speed, touching) {
		return touching ? (((speed * -1) / 2) | 0) : speed;
	});
var _elm_lang$elm_architecture_tutorial$Main$boundsCheck = function (model) {
	var _p5 = model.bounds;
	var boundsX = _p5._0;
	var boundsY = _p5._1;
	var _p6 = model.speed;
	var speedX = _p6._0;
	...
	var x = _p8._0;
	var y = _p8._1;
	var touchingX = (_elm_lang$core$Native_Utils.cmp(x, 0) < 1) || (_elm_lang$core$Native_Utils.cmp(x + sizeX, boundsX) > -1);
	var touchingY = (_elm_lang$core$Native_Utils.cmp(y, 0) < 1) || (_elm_lang$core$Native_Utils.cmp(y + sizeY, boundsY) > -1);
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			speed: {
				ctor: '_Tuple2',
				_0: A2(_elm_lang$elm_architecture_tutorial$Main$killSpeed, speedX, touchingX),
				_1: A2(_elm_lang$elm_architecture_tutorial$Main$killSpeed, speedY, touchingY)
			}
		});
};
var _elm_lang$elm_architecture_tutorial$Main$clamper = function (model) {
	var _p9 = model.size;
	var sX = _p9._0;
	var sY = _p9._1;
	var _p10 = model.bounds;
	var bx = _p10._0;
	var by = _p10._1;
	var _p11 = model.xy;
	var x = _p11._0;
	...
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			xy: {
				ctor: '_Tuple2',
				_0: A3(_elm_lang$core$Basics$clamp, 0, bx - sX, x),
				_1: A3(_elm_lang$core$Basics$clamp, 0, by - sY, y)
			}
		});
};
var _elm_lang$elm_architecture_tutorial$Main$update = F2(
	function (msg, model) {
		var _p12 = msg;
		if (_p12.ctor === 'TimeUpdate') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$elm_architecture_tutorial$Main$boundsCheck(
					_elm_lang$elm_architecture_tutorial$Main$clamper(
						A2(_elm_lang$elm_architecture_tutorial$Main$applyPhysics, _p12._0, model))),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			var _p13 = model.speed;
			var x = _p13._0;
			var y = _p13._1;
			var _p14 = _p12._0;
			switch (_p14) {
				case 37:
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								speed: {ctor: '_Tuple2', _0: x - 2, _1: y}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 38:
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								speed: {ctor: '_Tuple2', _0: x, _1: y - 2}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 39:
...
var _elm_lang$elm_architecture_tutorial$Main$newPosition = F2(
	function (pos, speed) {
		var _p15 = speed;
		var speedX = _p15._0;
		var speedY = _p15._1;
...
var _elm_lang$elm_architecture_tutorial$Main$Model = F5(
	function (a, b, c, d, e) {
		return {xy: a, speed: b, bounds: c, size: d, color: e};
	});
var _elm_lang$elm_architecture_tutorial$Main$marker = F5(
	function (position, speed, bounds, size, color) {
		return A5(_elm_lang$elm_architecture_tutorial$Main$Model, position, speed, bounds, size, color);
	});
var _elm_lang$elm_architecture_tutorial$Main$init = {
	ctor: '_Tuple2',
	_0: A5(
		_elm_lang$elm_architecture_tutorial$Main$marker,
...
var _elm_lang$elm_architecture_tutorial$Main$TimeUpdate = function (a) {
...
var _elm_lang$elm_architecture_tutorial$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$animation_frame$AnimationFrame$diffs(_elm_lang$elm_architecture_tutorial$Main$TimeUpdate),
				_elm_lang$keyboard$Keyboard$downs(_elm_lang$elm_architecture_tutorial$Main$KeyMsg)
			]));
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _elm_lang$elm_architecture_tutorial$Main$main === 'undefined' ? null : _elm_lang$elm_architecture_tutorial$Main$main);
